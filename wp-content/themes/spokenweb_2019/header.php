...
<head>
  ...
  <link rel="stylesheet" href="<?php bloginfo('template_directory'); ?>/_/js/mediaelementjs/mediaelementplayer.min.css">
	...
	<link rel="stylesheet" href="<?php bloginfo('template_directory'); ?>/style.css?v=1.94">
  ...
  <?php if (is_page('shortcuts') || $podcast_type == "ShortCuts"):?><link rel="stylesheet" href="<?php bloginfo('template_directory'); ?>/_/css/shortcuts.css?v=1.1"><?php endif;?>
...
<body <?php body_class("$header_class noscroll"); ?>>
	...
	<header id="header">
      ...
      <a class="navbar-brand" href="<?php echo home_url();?>"><div id="header_logo"></div></a>
