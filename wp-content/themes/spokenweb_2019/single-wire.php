<section class="container-fluid">
    ...
    ?>
        ...
        <small><?php if(isset($author) && $author!=""):?>By <?php echo $author;?>, <?php endif;?><time datetime="<?php echo date(DATE_W3C); ?>" pubdate class="updated"><?php the_time('F j, Y'); ?></time></small></h2>
			<?php include (TEMPLATEPATH . '/_/inc/meta-post-wire.php' ); ?>

			<div class="entry blogthumb">
				<?php  if ( has_post_thumbnail() ):?>
					<?php $img_thumb = wp_get_attachment_image_src( get_post_thumbnail_id(), 'large' ); $img_thumb = $img_thumb[0];?>
